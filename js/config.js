...
export const CONFIG = {
  ...
  /** Red — Normal fighter (Crimson Sniper) */
  normal: {
  ...
  melee: {
    ...
    rebounceLockChance: 0.5, // 50% chance to lock forward to target when bouncing off a wall
  },
  ...
  cronos: {
    ...
    maxFrozenProjectiles: 40, // max number of projectiles that can be frozen globally by sphere to prevent lag
  },
