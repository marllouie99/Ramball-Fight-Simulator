...
export const CONFIG = {
  ...
  darkModeShowHudSkillBars: 0,  // Toggle on/off to display HUD skill progress bars when Dark Mode is enabled (true = show all, false = hide with signature exceptions: Ichigo Bankai, Toji Ultimate, Gojo/Sukuna/Yuta/Mahito Domain Expansions, Saitama Serious Punch, Genos Ultimate, Yuji Black Flash Charges, Todo Boogie Woogie, Nanami Decisive Strike, Mahoraga Wheel of Adaptation, CJ Baguvix, Engineer Sentry, & John Wick EXCOMMUNICADO)
  darkModeShowHudStats: 0,      // Toggle on/off to display HUD fighter stats info (DMG, SPD, ATK, etc.) when Dark Mode is enabled (true = show, false = hide)
