...
export const zeusConfig = {
  ...
  lightningDamage: 10,         // Base damage per lightning hit (balanced with Sukuna slashes & Gojo basic)
  ...
  attackCooldown: 80,          // Synchronized attack cooldown (matches cooldown: 80)
  ...
  stunChance: 0.20,            // Initial fallback stun chance
  stunDuration: 24,            // Duration in frames (~0.4s) target is stunned on electric hit
  ...
  stormStrikeDamage: 6,        // Base damage per strike (15 strikes * 6 = 90 base dmg; ~115-120 with static bonus)
