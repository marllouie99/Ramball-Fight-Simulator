...
export const tojiConfig = {
  ...
  spearSlowDuration: 90,             // Duration in frames (1.5s) for slow movement debuff applied on basic attack hit
  spearSlowMultiplier: 0.50,         // Movement speed multiplier when slowed by basic attack (50% speed)
  basicAttackSlowDuration: 90,       // Alias duration (frames) for basic attack slow debuff
  basicAttackSlowMultiplier: 0.50,   // Alias multiplier for basic attack slow debuff
