...
import { MODE_HP_MULTIPLIER, MODE_SPEED_MULTIPLIER, GAME_MODES } from './modeConfig.js';
import { projectileSystem } from './projectileSystem.js';
import { playSound, stopAllSounds, stopAllLoopingSounds } from './soundSystem.js';
import { getBasicAttackSound } from './soundEffects/basicAttackSounds.js';
import { spawnDeathShatter } from './deathShatterEffect.js';
import { spawnBloodEffect } from './bloodEffect.js';
import { spawnIllusionDeath } from './illusionDeathEffect.js';
...
import { state, spawnFloatingText, recordWin, recordLoss } from './state.js';
    ...
    if (this.hp === 0 && state.gameState === 'playing') {
      ...
      if (this._def && this._def.type === 'doppleganger' &&
        ...
        if (attacker && attacker !== this) {
          attacker.lastKilledDef = this._def;
        }
        return true;
      }
      ...
      if (state.mode === '2v2') {
        ...
        // Record win/loss for leaderboard (1v1 mode only)
