...
function shouldApplyPhysicalPush(target) {
  ...
  if (target.characterId === 'escanor' || target.type === 'escanor' || target.characterId === 'cj' || target.type === 'cj' || target.characterId === 'eye_of_cthulhu' || target.type === 'eye_of_cthulhu' || target.characterId === 'ender_dragon' || target.type === 'ender_dragon' || target.isGhostTerrain || target.immuneToPush || target.immuneToKnockback) return false;
  return true;
}
