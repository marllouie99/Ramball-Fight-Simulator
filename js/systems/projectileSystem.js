...
class ProjectileSystem {
  ...
  _resetProjectileProperties(p) {
    ...
    p.isHeiligPfeil = false;
    p.isSkywardBeacon = false;
    p.isLichtRegenRain = false;
    p.isPiercing = false;
    p.isStuck = false;
    p.isCeroBeam = false;
    p.isFinalMassiveGetsuga = false;
    p.isDraggedByGetsuga = false;
    p.isLaylaBomb = false;
    ...
    p.pierceCount = undefined;
    p.maxPierces = undefined;
    p.ignoreArmor = undefined;
    p.lastAngle = undefined;
    p.launchAngle = undefined;
    p.originalAngle = undefined;
    p.draggedTargets = null;
    p.preventKnockbackBounce = false;
    p.getsugaReleaseId = undefined;
    p.getsugaTravelShakeCounter = undefined;
    p.getsugaWallShakeCounter = undefined;
