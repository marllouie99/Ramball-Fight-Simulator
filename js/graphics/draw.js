...
export { drawBlackHoleEffects, drawFloatingTexts, drawUltimateChannelingTexts, drawFlames, drawGenosSpeedLines, drawMahoragaSpeedLines, drawNanamiSpeedLines, drawSaitamaSpeedLines, drawIchigoBankaiSpeedLines, drawTojiSpeedLines, drawTodoTakadaDimScreen, drawTodoTakadaIdolScreenOverlay, isTodoTakadaOverlayActive, loadTodoUltimateOverlayImage, getTodoUltimateOverlayImage, drawTodoUltimateArenaOverlay, loadYujiSoulSwapOverlayImage, getYujiSoulSwapOverlayImage, isYujiSoulSwapOverlayActive, drawYujiSoulSwapArenaOverlay, drawYujiSoulSwapDimScreen } from './renderers/effectsRenderer.js';
export { drawFighters, drawIllusions } from './renderers/EntityRenderer.js';
export { drawPixelHand } from './renderers/fighterRenderer.js';
...
export { drawYutaSkin, drawYutaGhostSkin, drawYutaPixelBody, _drawYutaHair, _getYutaHairImage } from './fighters/yutaSkin.js';
export { drawYujiSkin, drawYujiPixelBody, _drawYujiHair, _getYujiHairImage } from './fighters/yujiSkin.js';
export { drawTodoSkin, drawTodoPixelBody, _drawTodoHair, _getTodoHairImage } from './fighters/todoSkin.js';
...
export { drawBomberSkin, drawBomberPixelBody, drawBomberBody, drawBomberGhostModel } from './fighters/bomberSkin.js';
export { drawVoidmasterSkin, drawVoidmasterPixelBody, drawVoidmasterBody, drawVoidmasterGhostModel } from './fighters/voidmasterSkin.js';
...
export { drawEnderDragonSkin, drawDragonAcidPool } from './fighters/enderDragonSkin.js';
...
export function drawThinIceBreakerDimScreen() {
  ...
  // Deep dark spatial frost cyan overlay
  ctx.fillStyle = `rgba(4, 28, 48, ${opacity * 0.90})`;
  ctx.fillRect(0, 0, canvas.width, canvas.height);
  ctx.restore();
  
  state.globalDimEdgeColor = `rgba(4, 28, 48, ${opacity})`;
}
