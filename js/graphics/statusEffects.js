export function drawBleedEffect(ctx, baseRadius, timer = 180, fighter = null) {
  ...
  if (typeof ctx.getTransform === 'function') {
    ...
    const hasGunAngleSkin = Boolean(fighter.characterId && (fighter.characterId === 'ulquiorra' || fighter.characterId === 'uryu' || fighter.characterId === 'john_wick' || fighter.characterId === 'toji' || fighter.characterId === 'megumi' || fighter.characterId === 'gojo' || fighter.characterId === 'sukuna' || fighter.characterId === 'yuta' || fighter.characterId === 'mahito' || fighter.characterId === 'mahoraga' || fighter.characterId === 'saitama' || fighter.characterId === 'nanami' || fighter.characterId === 'nobara' || fighter.characterId === 'yuji' || fighter.characterId === 'todo' || fighter.characterId === 'ichigo' || fighter.characterId === 'genos' || fighter.characterId === 'layla' || fighter.characterId === 'ruby' || fighter.characterId === 'cronos' || fighter.characterId === 'rubbick' || fighter.characterId === 'trickster' || fighter.characterId === 'darkslategray'));
