...
function drawHpPanel(fighter, x, y, alignRight, fighterIndex) {
  ...
  ctx.fillStyle = '#fff';
  ctx.font = isDark ? '700 9px "Silkscreen", "Press Start 2P", monospace' : 'bold 11px Arial';
  ctx.textAlign = alignRight ? 'left' : 'right';
  ctx.fillText(`${displayHp}/${displayMaxHp}`, alignRight ? px + padding : px + panelW - padding, y + (isDark ? 17 : 18));
